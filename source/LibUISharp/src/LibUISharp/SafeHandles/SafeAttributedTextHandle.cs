...
{
    /// <summary>
    /// Represents a wrapper class for an attributed text handle.
    /// </summary>
    public sealed class SafeAttributedTextHandle : SafeHandleZeroIsInvalid
    {
        /// <summary>
        ...
        public SafeAttributedTextHandle(IntPtr existingHandle, bool ownsHandle = true) : base(existingHandle, ownsHandle) { }
